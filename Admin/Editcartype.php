 	...
 	<!---->
        ...
        <form name="contactform" action="" method="post" enctype="multipart/form-data" onsubmit="return validate()">
			...
			<div class="col-md-12 form-group1">
              ...
              <input type="text" placeholder="cat_name" name="cat_name" value="<?php echo $fetch->cat_name;?>"<br>
            </div>
			
			
			<div class="col-md-12 form-group1">
              <label class="control-label">Cat Des</label>
              <input type="text" placeholder="cat_des"   name="cat_des" value="<?php echo $fetch->cat_des;?>"><br>
            </div>
			
						
			<div class="col-md-12 form-group1">
              <label class="control-label">Cat img</label>
              <input type="file" placeholder="cat_img" name="cat_img" value="<?php echo $fetch->cat_img;?>"><br>
			   <img src="../web/pic/<?php echo $fetch->cat_img;?>" height="80" width="80">
            </div>
             <div class="clearfix"> </div>
