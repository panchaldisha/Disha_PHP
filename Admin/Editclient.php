 	...
 	<!---->
        ...
        <form name="clientform" action="" method="post" enctype="multipart/form-data" onsubmit="return validate()">
			...
			<div class="col-md-12 form-group1 group-mail">
              ...
              <input type="text" name="address" value="<?php echo $fetch->address;?>" placeholder="contact no" >
            </div>
			
						
			<div class="col-md-12 form-group1 group-mail">
              <label class="control-label">Adhar card no</label>
              <input type="text" name="ad" value="<?php echo $fetch->ad;?>" placeholder="Adhar card no" >
            </div>
						
			<div class="col-md-12 form-group1 group-mail">
              <label class="control-label">Driving licence</label>
              <input type="text"  name="dri" value="<?php echo $fetch->dri;?>" placeholder="Driving licence" >
            </div>
			
						
			<div class="col-md-12 form-group1 group-mail">
              <label class="control-label">PUC NO</label>
              <input type="text" name="puc" value="<?php echo $fetch->puc;?>" placeholder="PUC NO" >
            </div>
			
						
			<div class="col-md-12 form-group1 group-mail">
              <label class="control-label">Insurance NO</label>
              <input type="text" name="insu" value="<?php echo $fetch->insu;?>" placeholder="Insurance NO" >
            </div>
